<div>
    <h1 class="text-xl">Inventory List</h1>
    ...
    <div class="flex flex-row flex-wrap mt-3">
        ...
        <div class="flex flex-row items-center flex-wrap gap-5">
            ...
            <a href="{{route('inventory.add')}}" class="pl-5 pr-5 pb-2 pt-2 theme-btn-bg text-white rounded flex flex-row items-center gap-2 cursor-pointer">
