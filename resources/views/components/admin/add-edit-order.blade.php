...
<div class="grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-12 mt-3 gap-5">
    <div class="xs:col-span-12 sm:col-span-12 md:col-span-8 min-h-7 shadow rounded p-3">
        ...
        <form class="mt-2" wire:submit.prevent="submitInventory">
            ...
            <div class="grid gap-6 mb-6 xs:cols-1 sm:cols-1 md:grid-cols-2">
                <div>
                ...
                <div>
                    <x-inputs.input-field :id="'total_amount'" :type="'number'" :label="'Total Amount'" />
                ...
                <div>
                    <label for="payment_status" class="block mb-2 text-sm font-medium text-gray-900 light:text-white">Payment Status</label>
